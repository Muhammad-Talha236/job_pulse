import { cleanJobDescription } from "./jobDescriptionCleaner.js"; // Import cleaner
  ...
  return {
    ...
    location:
      job.locations
        ...
        .join(", ") ||
      "Unknown Location",
    description: cleanJobDescription(job.contents || ""), // <-- Yahan cleanJobDescription wrap kar dein
    url:
