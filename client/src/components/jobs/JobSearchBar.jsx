...
function SuggestionDropdown({
  ...
  return (
    <div className="absolute left-0 right-0 top-[calc(100%+8px)] z-50 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_20px_50px_-20px_rgba(15,23,42,0.3)]">
      {loading && (
...
export default function JobSearchBar({
  ...
  return (
    <form
      onSubmit={onSearch}
      className="relative mt-9 w-full max-w-full rounded-2xl border border-slate-200 bg-white p-2 shadow-[0_15px_50px_-20px_rgba(15,23,42,0.25)]"
    >
